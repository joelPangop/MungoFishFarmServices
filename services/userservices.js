...
function basicDetails(user) {
    const {id, firstName, lastName, userName, roleID, email, supervisorID, userInfoID} = user;
    return {id, firstName, lastName, userName, roleID, email, supervisorID, userInfoID};
}
